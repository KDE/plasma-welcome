...
Kirigami.ApplicationWindow {
    ...
    KCM {
        ...
        description: i18nc("@info:usagetip", "Our developers will use this anonymous data to improve KDE software. You choose how much to share in System Settings, and here too.")
