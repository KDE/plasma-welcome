    ...
    view: Flickable {
        ...
        GridLayout {
            ...
            Kirigami.ListSectionHeader {
                ...
                label: i18nc("@title:group", "Pre-release Supporters")
            }

            Repeater {
                model: root.shuffle(root.preDonators)
            ...
            Kirigami.ListSectionHeader {
                ...
                label: i18nc("@title:group", "Post-release Supporters")
            }

            Repeater {
                model: root.shuffle(root.postDonators)
