...
ColumnLayout {
    ...
    Welcome.MockCard {
        ...
        Kirigami.PlaceholderMessage {
            ...
            text: i18nc("@info:placeholder", "Failed to load preview")
            explanation: {
                switch (Welcome.Release.previewError) {
                    case Welcome.Release.None:
                    default:
                        return null;
                    case Welcome.Release.NetworkCode:
                        return i18nc("@info:usagetip, %1 is an numeric error code", "A network error occured (%1)").arg(Welcome.Release.previewErrorCode);
