    ...
    Welcome.MockCard {
        ...
        Welcome.MockPanel {
            ...
            Item {
                ...
                Welcome.MockSystemTrayApplet {
                    id: mockTray

                    active: root.activeItem == mockTray

                    Welcome.MockSystemTrayIcon { source: "klipper-symbolic" }
                    Welcome.MockSystemTrayIcon { source: "audio-volume-high-symbolic" }
                }
            ...
            Welcome.MockDigitalClockApplet {
                id: mockClock
